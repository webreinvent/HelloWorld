    ...
    <Panel :pt="root.panel_pt">
        ...
        <div v-if="store.item" class="mt-2">
            ...
            <FloatLabel class="my-3" :variant="store.float_label_variants">
                ...
                <label for="articles-name">Enter the name</label>
            </FloatLabel>
            ...
            <FloatLabel class="my-3" :variant="store.float_label_variants">
                ...
                <label for="articles-slug">Enter the slug</label>
            </FloatLabel>
            ...
            <div class="flex items-center gap-2 my-3" >
                <ToggleSwitch v-bind:false-value="0"
                              ...
                              inputId="articles-active"
                              v-model="store.item.is_active"/>

                <label for="articles-active">Remember Me</label>
            </div>
